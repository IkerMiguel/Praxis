        ...
        <aside className="hidden w-64 shrink-0 flex-col justify-between border-r border-line/60 bg-white px-3 pb-3 pt-4 lg:flex">
          <div>
            ...
            <nav className="mt-3 space-y-1">
              <a
                href="#"
                className="flex items-center gap-3 rounded-md bg-ink px-3 py-2.5 text-[13px] font-semibold leading-[18px] text-white shadow-sm"
              >
              ...
              <a
                href="#"
                className="flex items-center gap-3 rounded-md px-3 py-2.5 text-[14px] leading-5 text-muted transition-colors hover:bg-panel"
              >
              ...
              >
                ...
                Mis Solicitudes
                <span className="ml-auto flex h-5 min-w-5 items-center justify-center rounded-full bg-brand px-1 text-[12px] font-bold leading-4 text-white">
                  3
                </span>
              </a>
            </nav>
